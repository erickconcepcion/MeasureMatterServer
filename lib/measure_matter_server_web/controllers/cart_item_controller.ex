defmodule MeasureMatterServerWeb.CartItemController do
  use MeasureMatterServerWeb, :controller

  alias MeasureMatterServer.{ShoppingCart, Catalog}

  def create(conn, %{"product_id" => product_id}) do
    product = Catalog.get_product!(product_id)
    cart = conn.assigns.cart
    case ShoppingCart.add_item_to_cart(cart, product) do
      {:ok, _item} ->
        conn
