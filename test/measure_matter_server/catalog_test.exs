defmodule MeasureMatterServer.CatalogTest do
  use MeasureMatterServer.DataCase

  alias MeasureMatterServer.Catalog

  describe "products" do
    alias MeasureMatterServer.Catalog.Product

    import MeasureMatterServer.CatalogFixtures
  ...
  describe "categories" do
    alias MeasureMatterServer.Catalog.Category
