defmodule MeasureMatterServer.OrdersTest do
  use MeasureMatterServer.DataCase

  alias MeasureMatterServer.Orders

  describe "orders" do
    alias MeasureMatterServer.Orders.Order

    import MeasureMatterServer.OrdersFixtures
  ...
  describe "order_line_items" do
    alias MeasureMatterServer.Orders.LineItem
