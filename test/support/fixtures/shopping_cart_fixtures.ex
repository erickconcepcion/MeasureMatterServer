defmodule MeasureMatterServer.ShoppingCartFixtures do
  @moduledoc """
  This module defines test helpers for creating
  entities via the `MeasureMatterServer.ShoppingCart` context.
  """
  ...
  def cart_fixture(attrs \\ %{}) do
    {:ok, cart} =
      ...
      |> MeasureMatterServer.ShoppingCart.create_cart()
  ...
  def cart_item_fixture(attrs \\ %{}) do
    {:ok, cart_item} =
      ...
      |> MeasureMatterServer.ShoppingCart.create_cart_item()
